...
export const parser = (line: string): ParsedLineType | null => {
  ...
  return stack.reduce<ParsedLineType>((result, item, key) => {
    ...
    const isValidOperatorPush =
      (isNumber(prevItem) && !isNumber(item) && Object.prototype.hasOwnProperty.call(mathOperators, item)) ||
      (Object.prototype.hasOwnProperty.call(mathOperators, item) && mathOperatorsPriorities[prevItem] === UNARY)
